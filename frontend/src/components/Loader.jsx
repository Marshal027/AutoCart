  ...
  return (
    <div className="loader-screen" ref={loaderRef}>
      <div className="loader-content">
        ...
        <div className="loader-tagline" style={{ opacity: 0 }}>
          Initializing Models
        </div>
        <div className="loader-line" style={{ opacity: 0 }}>
          <div className="loader-line-fill"></div>
        </div>
        <div className="loader-counter" style={{ opacity: 0 }}>
          {progress}%
        </div>
      </div>
      ...
      <div
        className="loader-strip loader-strip-5"
        style={{
      ...
      ></div>
      <div
        className="loader-strip loader-strip-4"
        style={{
      ...
      ></div>
      <div
        className="loader-strip loader-strip-3"
        style={{
      ...
      ></div>
      <div
        className="loader-strip loader-strip-2"
        style={{
      ...
      ></div>
      <div
        className="loader-strip loader-strip-1"
        style={{
          background: "var(--fg)",
          transform: "scaleY(0)",
          transformOrigin: "top",
